...
INPUT_LEN=${INPUT_LEN:-32000}
OUTPUT_LEN=${OUTPUT_LEN:-1000}
SLEEP_SECONDS=${SLEEP_SECONDS:-10}
TAG=${TAG:-32k_1k_cache0_gsm8k_conc160_pr11_chunk64k_graph124810_npu_moe_topk_0717}

mkdir -p "${OUTPUT_DIR}"

for i in $(seq 1 "${NUM_RUNS}"); do
  echo "===== 32k/1k 0 cache benchmark with GSM8K source run ${i}/${NUM_RUNS} ====="
