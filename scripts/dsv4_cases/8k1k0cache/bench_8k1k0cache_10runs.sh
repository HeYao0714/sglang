...
DATASET_PATH=${DATASET_PATH:-/home/t00937989/datasets/gsm8k/test_sharegpt_style.json}
OUTPUT_DIR=${OUTPUT_DIR:-/home/t00937989/zkk_new/high_throughput_bench}

NUM_RUNS=${NUM_RUNS:-3}
NUM_PROMPTS=${NUM_PROMPTS:-160}
MAX_CONCURRENCY=${MAX_CONCURRENCY:-160}
INPUT_LEN=${INPUT_LEN:-8000}
OUTPUT_LEN=${OUTPUT_LEN:-1000}
SLEEP_SECONDS=${SLEEP_SECONDS:-10}
TAG=${TAG:-8k_1k_cache0_gsm8k_conc160_pr11_chunk64k_graph124810_npu_moe_topk_0716}

mkdir -p "${OUTPUT_DIR}"

for i in $(seq 1 "${NUM_RUNS}"); do
  echo "===== 8k/1k 0 cache benchmark with GSM8K source run ${i}/${NUM_RUNS} ====="
