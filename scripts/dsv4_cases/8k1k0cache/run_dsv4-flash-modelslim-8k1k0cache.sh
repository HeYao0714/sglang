...
# path
export PYTHONPATH=/data/cjr/code/sglang-latest/sglang/python:$PYTHONPATH
MODEL_PATH=/data/weights/DeepSeek-V4-Flash-w8a8-mtp
MEM_FRACTION_STATIC=${MEM_FRACTION_STATIC:-0.7}
CUDA_GRAPH_BS=${CUDA_GRAPH_BS:-"1 2 4 8 10"}
...
export SGLANG_ZBAL_BOOTSTRAP_URL="tcp://113.46.13.20:14699"
