...
if [ "${ENABLE_ZBAL:-1}" = "1" ]; then
    ...
    export SGLANG_ZBAL_BOOTSTRAP_URL="${SGLANG_ZBAL_BOOTSTRAP_URL:-tcp://192.168.0.192:24699}"
...
CUDA_GRAPH_BS=${CUDA_GRAPH_BS:-"1 2 4 5"}
...
EXTRA_ARGS=${EXTRA_ARGS:-"--ep-size 16 --prefill-max-requests 2"}
